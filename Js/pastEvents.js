...
async function miFuncionNueva(){
    ...
    const pastEvents = eventos.filter(evento => (evento.date < fechaReferencia))
    crearEventos(pastEvents, "card-container") //<--------------------LLAMADO DE FUNCIONES
    crearCategorias(pastEvents, "containerCategoria") 
    ...
    function filtrarYmostrar() {
        let cardsXnombre = filterSearch(pastEvents, searchUser)//-----ARRAY DE EVENTS
